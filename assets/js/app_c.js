    ...
    legendGroup_x.selectAll('text')
        .on('click', function() {
            ...
            if (value !== chosen_xAxis) {
                chosen_xAxis = value;
                xLinearScale = xScale(census, chosen_xAxis);
                xAxis = render_xAxis(xLinearScale, xAxis);
                circleGroup = renderCircle(circleGroup, xLinearScale, chosen_xAxis, yLinearScale, chosen_yAxis);
                circleGroup = updateTooltip(chosen_xAxis, chosen_yAxis, circleGroup);
                textGroup = renderText(textGroup, xLinearScale, chosen_xAxis, yLinearScale, chosen_yAxis);
    ...
    legendGroup_y.selectAll('text')
        .on('click', function() {
            ...
            if (value !== chosen_yAxis) {
                chosen_yAxis = value;
                yLinearScale = yScale(census, chosen_yAxis);
